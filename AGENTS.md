...
- **`AppelAction`**, le bas de page à deux boutons : bandeau marine qui ferme une page, à la largeur d'une carte pour s'aligner sur les paragraphes qui le précèdent. **Il porte le titre de la page et deux boutons, jamais de texte**, et le premier bouton est toujours « Devenir membre ». Il est identique sur toutes les pages.
